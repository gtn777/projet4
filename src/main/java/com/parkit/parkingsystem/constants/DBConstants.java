...
public class DBConstants {
	...
	public static final String GET_PARKING_SPOT_QUANTITY = "SELECT COUNT(*) PARKING_NUMBER FROM parking;";
	...
	public static final String COUNT_TICKET = "SELECT * FROM ticket WHERE VEHICLE_REG_NUMBER = ? LIMIT 2";
}
